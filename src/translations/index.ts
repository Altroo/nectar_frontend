...
export const translations = {
	fr: {
		...
		listing: {
			...
			video: {
				kicker: 'Visite en vidéo',
				title: 'Découvrez nos appartements à louer',
				description: 'Entrez dans l’univers de nos appartements et découvrez en vidéo les espaces, les vues et l’atmosphère qui rendent chaque séjour à Tanger unique.',
				watch: 'Voir la vidéo sur YouTube',
			},
			search: 'Recherche',
	...
	ar: {
		...
		listing: {
			...
			video: {
				kicker: 'جولة بالفيديو',
				title: 'اكتشف شققنا المتوفرة للكراء',
				description: 'شاهد بالفيديو مساحات شققنا وإطلالاتها وأجواءها، واكتشف ما يجعل كل إقامة في طنجة تجربة مميزة.',
				watch: 'مشاهدة الفيديو على يوتيوب',
			},
			search: 'بحث',
	...
	en: {
		...
		listing: {
			...
			video: {
				kicker: 'Video tour',
				title: 'Discover our apartments for rent',
				description: 'Step inside our apartments and explore the spaces, views and atmosphere that make every stay in Tangier unique.',
	...
	es: {
		...
		listing: {
			...
			video: {
				kicker: 'Visita en vídeo',
				title: 'Descubra nuestros apartamentos en alquiler',
				description: 'Descubra en vídeo los espacios, las vistas y el ambiente que hacen única cada estancia en Tánger.',
